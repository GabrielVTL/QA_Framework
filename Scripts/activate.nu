...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Gabriel\Desktop\Framework\qa_framework\qa_framework'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Gabriel\Desktop\Framework\qa_framework\qa_framework\Scripts\deactivate.nu'
